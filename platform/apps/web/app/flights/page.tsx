...
export default function FlightsSearchPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      <Link href="/" className="text-sm text-burgundy underline underline-offset-4">
        &larr; Back home
      </Link>

      <div className="mt-6 text-center">
        <p className="mb-2 text-xs font-medium uppercase tracking-[0.25em] text-gold">Commercial Flights</p>
        <h1 className="font-display text-4xl font-semibold text-burgundy">Search Business &amp; First Class</h1>
      </div>

      <form onSubmit={handleSubmit} className="mx-auto mt-8 rounded-2xl border border-gold/25 bg-cream-deep p-8 shadow-sm">
