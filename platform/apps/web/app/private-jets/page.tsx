  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      ...
      <div className="mt-6 text-center">
        <p className="mb-2 text-xs font-medium uppercase tracking-[0.25em] text-azure">Business Jets</p>
        <h1 className="font-display text-4xl font-semibold text-charcoal">Search Empty-Leg Charters</h1>
      </div>
